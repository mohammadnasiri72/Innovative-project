    ...
    <>
      <div className="flex justify-center items-center h-screen main-box-bob">
        <div className="w-80 h-96 bg-[#fbf468] relative">
          <img className="w-40 h-48 mx-auto" src="./images/bob/bobno.png" alt="" />
          <img className="absolute top-10 left-24 ml-3 w-10 h-10 duration-300" src="./images/bob/eye.png" alt="" style={{transform:isFocusUserName?`translate(${x-20}% , 20%)`:isFocusPassword?`translate(0% , -20%)`:`translate(0% , 0%)`}}/>
          <img className="absolute top-10 left-40 ml-3 w-10 h-10 duration-300" src="./images/bob/eye.png" alt="" style={{transform:isFocusUserName?`translate(${x-20}% , 20%)`:isFocusPassword?`translate(0% , -20%)`:`translate(0% , 0%)`}} />
          <form className="mt-7">
